	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord4 = input.ase_texcoord9.xy * float2( 2,1 ) + float2( 0,0 );
				...
				float2 texCoord15 = input.ase_texcoord9.xy * float2( 2,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId10 = 0;
				float mulTime3 = _TimeParameters.x * _UVScrollSpeed;
				float2 texCoord4 = input.ase_texcoord3.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner5 = ( mulTime3 * float2( 0,1 ) + texCoord4);
				float2 coords10 = panner5 * 1.0;
				float2 id10 = 0;
				float2 uv10 = 0;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float mulTime3 = _TimeParameters.x * _UVScrollSpeed;
				float2 texCoord4 = input.ase_texcoord4.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner5 = ( mulTime3 * float2( 0,1 ) + texCoord4);
				float4 blendOpSrc24 = ( _Emission * ( _WaterColour * tex2D( _ColourMask, panner5 ) ) );
				float4 blendOpDest24 = _WaterColour;
				float4 lerpBlendMode24 = lerp(blendOpDest24,( 1.0 - ( 1.0 - blendOpSrc24 ) * ( 1.0 - blendOpDest24 ) ),_WaterOverlayPower);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float mulTime3 = _TimeParameters.x * _UVScrollSpeed;
				float2 texCoord4 = input.ase_texcoord2.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner5 = ( mulTime3 * float2( 0,1 ) + texCoord4);
				float4 blendOpSrc24 = ( _Emission * ( _WaterColour * tex2D( _ColourMask, panner5 ) ) );
				float4 blendOpDest24 = _WaterColour;
				float4 lerpBlendMode24 = lerp(blendOpDest24,( 1.0 - ( 1.0 - blendOpSrc24 ) * ( 1.0 - blendOpDest24 ) ),_WaterOverlayPower);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float mulTime11 = _TimeParameters.x * _UVScrollSpeed;
				float2 texCoord15 = input.ase_texcoord5.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner20 = ( mulTime11 * float2( 0,1 ) + texCoord15);
				
				float time10 = 0.0;
				float2 voronoiSmoothId10 = 0;
				float mulTime3 = _TimeParameters.x * _UVScrollSpeed;
				float2 texCoord4 = input.ase_texcoord5.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner5 = ( mulTime3 * float2( 0,1 ) + texCoord4);
				float2 coords10 = panner5 * 1.0;
				float2 id10 = 0;
				float2 uv10 = 0;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.RangedFloatNode;1;-2600.454,-168.0422;Float;False;Property;_UVScrollSpeed;UVScroll Speed;6;0;Create;True;0;0;0;False;0;False;0.5;0.717;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;6;-1733.814,-555.2261;Inherit;False;Property;_WaterColour;WaterColour;0;0;Create;True;0;0;0;False;0;False;0.1933517,0.745283,0.6866668,0;0.4424616,0.5274525,0.5754716,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;7;-1982.081,-223.7788;Inherit;True;Property;_ColourMask;ColourMask;7;0;Create;True;0;0;0;False;0;False;-1;cb3f411ea46ea3342912d9a41154e5e5;cb3f411ea46ea3342912d9a41154e5e5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-1628.168,-15.41569;Inherit;False;Property;_Emission;Emission;1;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-743.3003,-660.7462;Inherit;False;Property;_FresnelPower;FresnelPower;11;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;12;-1047.615,452.2958;Inherit;False;Property;_VertOffsetPower;VertOffsetPower;8;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.ColorNode;17;-381.7032,-596.4398;Inherit;False;Property;_FresnelColour;FresnelColour;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9858491,0.9888815,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1035.318,-86.23483;Inherit;False;Property;_WaterOverlayPower;WaterOverlayPower;3;0;Create;True;0;0;0;False;0;False;1;0.751;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;28;-546.1806,507.1683;Inherit;True;Property;_Dirt_Normals_01;Dirt_Normals_01;10;0;Create;True;0;0;0;False;0;False;-1;abc7d86babc385d4c8707eb4c4d8aecd;6f7201a46a43e824bb35cd183f7a5e20;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch;27;-454.149,214.7603;Inherit;False;Property;_VertexOffset_Toggle;VertexOffset_Toggle;9;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-440.3883,21.65127;Inherit;False;Property;_Metallic;Metallic;5;0;Create;True;0;0;0;False;0;False;1;0.299;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-53.63574,176.6318;Inherit;False;Property;_Opacity;Opacity;2;0;Create;True;0;0;0;False;0;False;1;0.615;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-439.6601,104.673;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;1;0.294;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4DFE1992F6AE2684D7CFC718091D3D917AD3C561