	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Moon_01 = input.ase_texcoord9.xy * _Moon_01_ST.xy + _Moon_01_ST.zw;
				float4 tex2DNode2 = tex2D( _Moon_01, uv_Moon_01 );
				

				float3 BaseColor = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( ( tex2DNode2 * _EmissionColour ) * _EmissionPower ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Moon_01 = input.ase_texcoord3.xy * _Moon_01_ST.xy + _Moon_01_ST.zw;
				float4 tex2DNode2 = tex2D( _Moon_01, uv_Moon_01 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_Moon_01 = input.ase_texcoord4.xy * _Moon_01_ST.xy + _Moon_01_ST.zw;
				float4 tex2DNode2 = tex2D( _Moon_01, uv_Moon_01 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_Moon_01 = input.ase_texcoord2.xy * _Moon_01_ST.xy + _Moon_01_ST.zw;
				float4 tex2DNode2 = tex2D( _Moon_01, uv_Moon_01 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_Moon_01 = input.ase_texcoord5.xy * _Moon_01_ST.xy + _Moon_01_ST.zw;
				float4 tex2DNode2 = tex2D( _Moon_01, uv_Moon_01 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 uv_Moon_01 = input.ase_texcoord.xy * _Moon_01_ST.xy + _Moon_01_ST.zw;
				float4 tex2DNode2 = tex2D( _Moon_01, uv_Moon_01 );
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.SamplerNode;2;-449,-28;Inherit;True;Property;_Moon_01;Moon_01;0;0;Create;True;0;0;0;False;0;False;-1;49932ae08a9c9074693121a4946c4212;49932ae08a9c9074693121a4946c4212;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;5;-348,454;Inherit;False;Property;_EmissionColour;EmissionColour;2;0;Create;True;0;0;0;False;0;False;1,0.01415092,0.9477745,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
