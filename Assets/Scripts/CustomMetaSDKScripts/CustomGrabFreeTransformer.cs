...
{
    [SerializeField] [Tooltip("Constrains the position of the object along different axes. Units are meters.")]
    ...
    [SerializeField] [Tooltip("Constrains the rotation of the object along different axes. Units are degrees.")]
    ...
    #region Accessors
    public TransformerUtils.PositionConstraints PositionConstraints => _positionConstraints;
    public TransformerUtils.RotationConstraints RotationConstraints => _rotationConstraints;
    public TransformerUtils.ScaleConstraints ScaleConstraints => _scaleConstraints;
    #endregion
    ...
    public void UpdateTransform()
    {
        ...
        targetTransform.rotation =
            TransformerUtils.GetConstrainedTransformRotation(rotation, _rotationConstraints, targetTransform.parent);

        Vector3 position = localPosition - targetTransform.TransformVector(_grabDeltaInLocalSpace.position);
        targetTransform.position =
            TransformerUtils.GetConstrainedTransformPosition(position, _relativePositionConstraints,
